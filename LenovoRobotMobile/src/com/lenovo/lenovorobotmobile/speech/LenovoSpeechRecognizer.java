...
public abstract class LenovoSpeechRecognizer {
	...
	public LenovoSpeechRecognizer(Context context) {
		// 获取上下文
		mContext = context;
		...
		// 设置APPID
		SpeechUtility.createUtility(context, SpeechConstant.APPID + "=555ebcf5");
		// 初始化识别对象
	...
	public void start() {
		if (null == mIat) {
			...
			if (ret != ErrorCode.SUCCESS) {
				Toast.makeText(mContext, "听写失败,错误码111：" + ret, Toast.LENGTH_SHORT).show();
			}
		}
	}
