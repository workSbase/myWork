...
public class AnimationTools {
	...
	public AnimationTools(View view, View view1, View view2) {
	...
	private void initAnimation() {
		animation = new ScaleAnimation(0.0f, 3.5f, 0.0f, 3.5f,
				Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF,
				0.5f);
		animation.setDuration(3000);
		animation.setFillAfter(false);

		animation1 = new ScaleAnimation(0.0f, 3.5f, 0.0f, 3.5f,
				Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF,
				0.5f);
		...
		animation2 = new ScaleAnimation(0.0f, 3.5f, 0.0f, 3.5f,
				Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF,
				0.5f);
