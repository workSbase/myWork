...
include $(CLEAR_VARS)
LOCAL_STATIC_JAVA_LIBRARIES :=agora-rtc-sdk android-async-http-1.4.8 plato-client-api-0.2 avoscloud-sdk-v3.7.5 avoscloud-statistics-v3.7.5 Msc eventbus-2.4.0 fastjson jackson-all-1.8.5 gson-2.2.1 gson-2.2.1 android-support-v4 commons-lang3-3.0-beta
...
commons-lang3-3.0-beta:libs/commons-lang3-3.0-beta.jar 
